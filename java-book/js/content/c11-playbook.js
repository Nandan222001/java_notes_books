/* ===== CHAPTERS 32–33 · Interview Playbook & Finale ===== */
(function () {
var B = window.BOOK;
B.chapter('pf', 32, 'The Interview Playbook');

/* spread 1 */
B.spread(
{ kicker: 'FINALE · INTERVIEW PLAYBOOK', head: 'Ch 32 · Strategy',
html: `<h2 class="chap"><span class="chnum">CHAPTER 32</span>The Playbook — Turning Knowledge Into Offers 🎯</h2>
...
/* Chapter 32 · spread 2 — the rounds & the close */
B.spread(
{ kicker: 'FINALE · INTERVIEW PLAYBOOK', head: 'Ch 32 · Round Day',
html: `<h2 class="chap"><span class="chnum">CHAPTER 32 · CONT.</span>Round-Day Script &amp; The Close</h2>
...
B.chapter('pf', 33, 'The Finish Line');
B.spread(
{ kicker: 'EPILOGUE', head: 'You Made It',
html: `<h2 class="chap"><span class="chnum">CHAPTER 33 · THE END</span>A Letter To The Reader Who Finished</h2>
